...
const ApproachSection = () => {
  ...
  return (
    <section className="approch">
      ...
      <div className="approch__inner">
        <div className="approch__tile-wrapper">
          <h2 className="approch__title">
            My Approach:
            <br /> <span className="black-bold--primar">Real Solutions</span> That Scale and Last
          </h2>
        </div>
